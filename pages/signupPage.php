    ...
    <div class="login_body_wrapper">
        <div class="login__form_wrapper">
            ...
            <form id="form" action="../signup.php" method="post">
                ...
                <div class="login__form_block">
                    <input class="popup__input" type="email" name="email" placeholder="E-mail" required>
                    <?php if ($error == "'email'") echo '<span class="login__form_erorr">Пользователь с такой почтой уже существует</span>' ?>
                </div>
                <div class="login__form_block">
                    <input id="formInputPassword" class="popup__input" type="password" name="password" placeholder="Пароль" required>
                </div>
                <div class="login__form_block">
                    <input id="formInputConfirmPassword" class="popup__input" type="password" name="confirm_password" placeholder="Подтверждение пароля" required>
                </div>
                <div class="login__form_block">
